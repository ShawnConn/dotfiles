...
#######   FUNCTIONS   ##########################################################
source "$HOME/.shell/zsh/functions/cpv"
source "$HOME/.shell/zsh/functions/docker"
source "$HOME/.shell/zsh/functions/iterm2"
source "$HOME/.shell/zsh/functions/iterm2-shell-integration"
source "$HOME/.shell/zsh/functions/macos"
source "$HOME/.shell/zsh/functions/misc"

#######   COMPLETIONS   ########################################################
# Add custom ZSH completions
fpath=("$HOME/.shell/zsh/completions" $fpath)
