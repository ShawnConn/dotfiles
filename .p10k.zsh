# Generated by Powerlevel10k configuration wizard on 2024-07-09 at 11:14 EDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    # kubecontext           # current kubernetes context (https://kubernetes.io/)
    # terraform             # terrafmrm workspace (https://www.terraform.io)
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_VIOWR_BACKGROUND=124
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VIOWR_CONTENT_EXPANSION=' 󱞨'
  ...
  typeset -g POWERLEVEL9K_TERRAFORM_VERSION_FOREGROUND=57
